...
function calcPositionDiff(oldPosition, newPosition) {
    ...
    function groupByPiece(position) {
        ...
        Object.entries(position).forEach(([square, piece]) => {
            groups[piece.color][piece.pieceType].squares.push(square);
        });
        return groups;
    }
...
class GChessBoardElement extends HTMLElement {
    ...
    constructor() {
        ...
        Object.defineProperty(this, "_boardArrowsWrapper", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
